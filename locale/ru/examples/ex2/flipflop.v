...
wire w21;    //: /sn:0 {0}(174,344)(257,344)(257,344)(339,344){1}
//: {2}(343,344)(476,344){3}
//: {4}(480,344)(633,344){5}
...
//: enddecls
  ...
  OSCILLATOR #(.HZ(500)) g4 (.Z(w21));   //: @(160, 344) /symbol:161908056 /sn:0 /w:[ 0 ]
  ...
  //: SWITCH g5 (w6) @(160,169) /sn:0 /w:[ 7 ] /st:1 /dn:0
