...
//: enddecls
  ...
  //: comment g1 @(14,90)
  //: /line:"Данная схема содержит несмложный процессор."
  //: /line:"Симуляционный скрипт заставляет его"
  //: /line:"исполнять игру \"Animals\" как только Вы"
  //: /line:"активируете режим симуляции. Click on"
...
//: enddecls
  ...
  TTY tty0 (.TD(TD), .DSR(DSR), .RTS(RTS), .RD(RD), .CTS(CTS), .DTR(DTR));   //: @(396, 962) /symbol:76404168 /w:[ 0 0 0 0 1 0 ]
