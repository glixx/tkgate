...
//: enddecls
  ...
  //: /line:"можете вернуться к родительскому"
  //: /line:"модулю, нажав клавишу '&lt;'. Во"
  //: /line:"время симуляции щёлкните по"
  //: /line:"проводнику, чтобы увидеть текущее"
  //: /line:"значение сигнала или установите"
  //: /line:"зонд двойным щелчком, чтобы добавить"
  //: /line:"график к логическому анализатору."
  //: /line:""
  //: /line:"Ниже приведены ссылки на файлы"
  //: /line:"поддержки данной схемы:"
  //: /line:""
...
//: enddecls
  ...
  TTY tty0 (.TD(TD), .DSR(DSR), .RTS(RTS), .RD(RD), .CTS(CTS), .DTR(DTR));   //: @(396, 962) /symbol:163836864 /w:[ 0 0 0 0 1 0 ]
