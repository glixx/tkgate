...
//: enddecls
  ...
  REGS g2 (.SA(sa), .AIN(w12), .AOUT(w14), .SB(sb), .BOUT(w30), .ck(w33));   //: @(165, 479) /symbol:168939208 /sn:0 /w:[ 0 0 0 0 0 0 ]
  ...
  //: /line:"  лицензии и гарантиях. Сообщайте о проблемах на <a href=\"mailto:hansen@tkgate.org\"><value-of name=\"tkgate-mailcontact\"></a> (по англиски)."
