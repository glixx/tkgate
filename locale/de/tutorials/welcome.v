...
//: property locale = "de"
//: property prefix = "_GG"
//: property title = "Willkommen bei TkGate"
...
//: enddecls
  ...
  REGS g2 (.SA(sa), .AIN(w12), .AOUT(w14), .SB(sb), .BOUT(w30), .ck(w33));   //: @(165, 479) /symbol:160895448 /sn:0 /w:[ 0 0 0 0 0 0 ]
...
//: /netlistBegin ALU
module ALU(F, A, B, Z);
//: interface  /sz:(89, 65) /bd:[ Ti0>B[7:0](67/89) Ti1>A[7:0](21/89) Li0>F[1:0](39/65) Bo0<Z[7:0](44/89) ] /pd: 0 /pi: 0 /pe: 0 /pp: 1
