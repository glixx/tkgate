...
reg b;    //: {0}(41:73,97)(109,97){1}
//: {2}(111,95)(111,67)(127,67){3}
//: {4}(111,99)(111,143)(139,143){5}
supply1 w7;    //: /sn:0 {0}(456,31)(456,18){1}
reg [7:0] w19;    //: /sn:0 {0}(#:703,66)(703,39){1}
reg w0;    //: /sn:0 {0}(357,39)(429,39){1}
//: {2}(433,39)(442,39){3}
//: {4}(431,37)(431,29){5}
//: {6}(431,41)(431,127)(481,127){7}
reg [1:0] w21;    //: /sn:0 {0}(#:136,463)(96,463)(96,428)(90,428){1}
reg w28;    //: /sn:0 {0}(69,268)(89,268)(89,268)(118,268){1}
reg w20;    //: /sn:0 {0}(661,137)(624,137){1}
reg [1:0] w23;    //: /sn:0 {0}(#:136,478)(90,478){1}
reg w1;    //: /sn:0 {0}(357,73)(392,73){1}
//: {2}(396,73)(442,73){3}
//: {4}(394,71)(394,64){5}
//: {6}(394,75)(394,126)(409,126){7}
reg [7:0] w25;    //: /sn:0 {0}(#:90,208)(131,208)(131,252){1}
supply0 w18;    //: /sn:0 {0}(741,206)(741,188)(723,188){1}
reg ci;    //: {0}(12:73,26)(177,26)(177,68){1}
//: {2}(179,70)(202,70){3}
//: {4}(177,72)(177,99){5}
supply0 w11;    //: /sn:0 {0}(759,102)(759,80)(743,80){1}
supply0 w2;    //: /sn:0 {0}(495,136)(495,152)(458,152){1}
//: {2}(454,152)(423,152)(423,135){3}
//: {4}(456,154)(456,163){5}
supply1 w10;    //: /sn:0 {0}(723,178)(737,178)(737,160){1}
reg a;    //: {0}(30:73,62)(115,62){1}
//: {2}(119,62)(127,62){3}
//: {4}(117,64)(117,138)(139,138){5}
...
wire w4;    //: /sn:0 {0}(205,141)(160,141){1}
wire w3;    //: /sn:0 {0}(205,136)(175,136)(175,120){1}
wire w24;    //: /sn:0 {0}(695,80)(685,80){1}
wire co;    //: {0}(245,129)(-68:245,139)(226,139){1}
wire w8;    //: /sn:0 {0}(202,65)(174,65){1}
//: {2}(170,65)(148,65){3}
//: {4}(172,67)(172,99){5}
...
wire s;    //: {0}(246,80)(39:246,68)(223,68){1}
wire w13;    //: /sn:0 {0}(423,118)(423,99)(454,99){1}
//: {2}(458,99)(493,99){3}
//: {4}(495,97)(495,87){5}
//: {6}(495,101)(495,119){7}
//: {8}(456,97)(456,82){9}
wire w5;    //: /sn:0 {0}(456,48)(456,65){1}
...
//: enddecls
  ...
  _GGNMOS #(2, 1) g4 (.Z(w13), .S(w2), .G(w0));   //: @(489,127) /sn:0 /w:[ 7 0 7 ]
  //: LED g55 (w0) @(431,22) /sn:0 /w:[ 5 ] /type:0
  _GGOR2 #(6) g34 (.I0(w3), .I1(w4), .Z(co));   //: @(216,139) /sn:0 /w:[ 0 0 1 ] /eb:0
  //: joint g13 (w1) @(394, 73) /w:[ 2 4 1 6 ]
  //: SWITCH g3 (w0) @(340,39) /sn:0 /w:[ 0 ] /st:0 /dn:0
  _GGCLOCK_P200_0_50 g51 (.Z(w33));   //: @(46,529) /sn:0 /w:[ 1 ] /omega:200 /phi:0 /duty:50
  REGS g2 (.SA(w21), .AIN(w12), .AOUT(w14), .SB(w23), .BOUT(w30), .ck(w33));   //: @(165, 479) /symbol:162179816 /sn:0 /w:[ 0 0 0 0 0 0 ]
  //: LED g59 (w30) @(213,288) /sn:0 /w:[ 3 ] /type:2
  _GGCLOCK_P120_0_50 g1 (.Z(clk));   //: @(580,183) /sn:0 /w:[ 0 ] /omega:120 /phi:0 /duty:50
  //: joint g11 (w2) @(456, 152) /w:[ 1 -1 2 4 ]
  //: joint g16 (w30) @(213, 310) /w:[ 1 2 4 -1 ]
  _GGAND2 #(6) g28 (.I0(a), .I1(b), .Z(w4));   //: @(150,141) /sn:0 /w:[ 5 5 1 ] /eb:0
  //: GROUND g10 (w2) @(456,169) /sn:0 /w:[ 5 ]
  //: joint g32 (w8) @(172, 65) /w:[ 1 -1 2 4 ]
  //: SWITCH g27 (ci) @(56,26) /sn:0 /w:[ 0 ] /st:0 /dn:0
  //: joint g19 (w0) @(431, 39) /w:[ 2 4 1 6 ]
  _GGNMOS #(2, 1) g6 (.Z(w13), .S(w2), .G(w1));   //: @(417,126) /sn:0 /w:[ 0 3 7 ]
  //: DIP sa (w21) @(52,428) /R:1 /w:[ 1 ] /st:0 /dn:0
  //: joint g57 (w13) @(495, 99) /w:[ -1 4 3 6 ]
  //: joint g9 (w13) @(456, 99) /w:[ 2 8 1 -1 ]
  ...
  //: DIP sb (w23) @(52,478) /R:1 /w:[ 1 ] /st:1 /dn:0
  ...
  //: DIP func (w26) @(52,331) /R:1 /w:[ 0 ] /st:0 /dn:0
  //: LED g62 (w14) @(213,211) /sn:0 /w:[ 3 ] /type:2
  //: joint g29 (a) @(117, 62) /w:[ 2 -1 1 4 ]
  //: SWITCH g25 (a) @(56,62) /sn:0 /w:[ 0 ] /st:0 /dn:0
  //: joint g17 (w14) @(213, 237) /w:[ 1 2 4 -1 ]
  //: DIP g42 (w19) @(703,29) /sn:0 /w:[ 1 ] /st:248 /dn:0
  //: DIP data_in (w25) @(52,208) /R:1 /w:[ 0 ] /st:11 /dn:0
  //: LED g56 (w13) @(495,80) /sn:0 /w:[ 5 ] /type:0
  _GGPMOS #(2, 1) g5 (.Z(w13), .S(w5), .G(w1));   //: @(450,73) /sn:0 /w:[ 9 1 3 ]
  //: LED g14 (co) @(245,122) /sn:0 /w:[ 0 ] /type:0
  _GGMUX2x8 #(8, 8) g47 (.I0(w9), .I1(w22), .S(w20), .Z(w27));   //: @(684,137) /sn:0 /w:[ 1 0 0 0 ] /ss:0 /do:0
  //: SWITCH g44 (w20) @(607,137) /sn:0 /w:[ 1 ] /st:1 /dn:0
  ...
  //: /line:""
  //: /line:"<font size=5>以下のリンクにクリックして、tkgateを使え始めよう。"
  //: /line:""
  //: /line:"   <a href=\"file:///@T/index.v\">*  チュートリアルへ</a>"
  //: /line:""
  //: /line:"   <a href=\"file:///@E/index.v\">* 例題回路へ</a>"
  //: /line:""
