 ...
 * Version Flag codes.
 */
#define VF_OLD		0x1	/* This is an old, possibly incompatable
				 * version */
#define VF_NOBACK	0x2	/* Save file may be unreadable in earlier
				 * versions */
#define VF_UNKNOWN	0x4	/* Unknown version number (future
				 * version?) */
...
#define ST_LITERAL	1	/* A literal token such as "foo" and
				 * "_bar" */
#define ST_NUMBER	2	/* A number token such as "1", "0.2",
				 * "5e-10" */
