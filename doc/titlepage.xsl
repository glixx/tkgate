...
<xsl:template name="book.titlepage.recto">
  ...
  <xsl:apply-templates mode="book.titlepage.recto.auto.mode" select="info/graphic"/>
...
<div xmlns="http://www.w3.org/1999/xhtml" xsl:use-attribute-sets="topic.titlepage.recto.style">
